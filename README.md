...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8119&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/colcon-recursive-crawl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `colcon-recursive-crawl` can be installed with:

```
conda install colcon-recursive-crawl
```

It is possible to list all of the versions of `colcon-recursive-crawl` available on your platform with:
